...
def dashboard(request: Request):
    ...
    with get_db() as db:
        ...
        active = [
            ...
            for r in db.execute(
                ...
                JOIN pricing pr
                ON pr.vehicle_type=v.vehicle_type
    ...
    for record in active:
        ...
        record["overstay"] = (
            hours > record["overstay_hours"]
        )

        record["parked_hours"] = max(
            0,
            hours
        )
